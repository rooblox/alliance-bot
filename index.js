...
/* =======================
   STAFF STRIKES
======================= */
if (commandName === 'staff' && options.getSubcommand() === 'strikes') {
    await interaction.deferReply({ ephemeral: true });

    const strikesPath = path.join(__dirname, 'staffStrikes.json');
    let strikes = [];
    ...
    return interaction.editReply(`✅ Loaded **${strikes.length}** strike(s).`);
}
