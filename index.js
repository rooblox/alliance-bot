...
client.on('interactionCreate', async interaction => {
    ...
    if (commandName === 'staff') {
        ...
        // ADD Strike/Termination/Blacklisted
        if (action === 'add') {
            if (category === 'Strike') {
                ...
                return interaction.editReply('⚠️ Strike added and user notified');
            }

            // Termination or Blacklisted add
            if (category === 'Termination' || category === 'Blacklisted') {
                const dmEmbed = new EmbedBuilder()
        ...
        // REMOVE Strike/Termination/Blacklisted
        if (action === 'remove') {
            if (category === 'Strike') {
    ...
    if (commandName === 'rep') {
        ...
        if (sub === 'request') {
            ...
            if (channel) {
                ...
                channel.send({ content: role ? `${role}` : '', embeds: [embed] });
            }
